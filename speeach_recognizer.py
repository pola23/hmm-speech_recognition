# python speeach_recognizer.py -i C:/Users/carlc/Downloads/speech_recognition_hmm-master/speech_recognition_hmm-master/data
...
if __name__ == '__main__':
    ...
    for input_file in input_files:
        ...
        mfcc_features = mfcc(audio, sampling_freq)
        max_score = float('-inf')  # Initialize max_score as float('-inf')
        output_label = None  # Initialize output_label as None
